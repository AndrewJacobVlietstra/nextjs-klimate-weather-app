			...
			<CardContent>
				<div className="grid gap-4">
					{dailyForecastsArr.map((forecast) => (
						<div
							key={forecast.date}
							className="grid grid-cols-[1.6fr_1.3fr_1fr] gap-4 items-center rounded-lg border p-4 bg-background/50 hover:bg-background/100 transition-colors"
						>
							<div className="flex items-center justify-around">
								...
								<div className="flex-1 max-w-[60px] aspect-square">
									<Image
